...
\subsection{Pictures}
\img{p2-packets}{All http packets in HW2-P2.pcapng}
\img{p2-GET-Transmission-Layer}{Transmission Layer}
...
\img{p2-tcp-packets}{TCP Packets involved in setting up and gracefully closing the connection used by the HTTP GET and response}
